...
Tsky_file = '/data4/tcox/HERA_IDR1_analysis/HERA_Tsky_nic.npz'
...
autos_file = '/data4/tcox/HERA_IDR1_analysis/IDR2_autos.npz'
...
beam_file = '/data4/tcox/instr_data/HERA_beam_nic.hmap'
...
outdir = '/data4/tcox/HERA_IDR2_analysis/2458098/'

if save_data:
    np.savez(outdir + 'fits', gains = gains,
             rxr_temp = rxr_temp, HERA_list = HERA_list,
             nrao_feeds = nrao_feeds, data_lsts = data_lsts,
             auto_fits)
